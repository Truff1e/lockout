...
defaultGoalDictionary = {
        ...
        'K0016': ['Kill Player', 'iron_sword', True, 3],
...
exclusiveSets = {
        ...
        'killSheep': {
                'K1001': ['Kill White Sheep', 'white_wool', False, 1], 
                'K1002': ['Kill Pink Sheep', 'pink_wool', False, 1], 
                'K1003': ['Kill Magenta Sheep', 'magenta_wool', False, 1], 
                'K1004': ['Kill Red Sheep', 'red_wool', False, 1], 
                'K1005': ['Kill Orange Sheep', 'orange_wool', False, 1], 
                'K1006': ['Kill Yellow Sheep', 'yellow_wool', False, 1], 
                'K1007': ['Kill Lime Sheep', 'lime_wool', False, 3], 
                'K1008': ['Kill Green Sheep', 'green_wool', False, 3], 
                'K1009': ['Kill Cyan Sheep', 'cyan_wool', False, 3], 
                'K1010': ['Kill Light Blue Sheep', 'light_blue_wool', False, 1], 
                'K1011': ['Kill Blue Sheep', 'blue_wool', False, 1], 
                'K1012': ['Kill Purple Sheep', 'purple_wool', False, 1], 
                'K1013': ['Kill Brown Sheep', 'brown_wool', False, 3], 
                'K1014': ['Kill Light Gray Sheep', 'light_gray_wool', False, 1], 
                'K1015': ['Kill Gray Sheep', 'gray_wool', False, 1], 
                'K1016': ['Kill Black Sheep', 'black_wool', False, 1], 
        },
