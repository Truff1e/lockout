...
execute if score #game_begun lk.util matches 1 run title @a actionbar [{"text": "Time Remaining: ", "color": "light_purple"},{"score":{"name": "#time_remaining", "objective": "lk.util"}, "color": "light_purple"},{"text": " minutes","color": "light_purple"}]
...
execute as @r if score @s lk.points >= #boardSize lk.util unless score #end_seen lk.util matches 1 run function lockout:game/win
