execute unless score #I0112 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0112] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0112
tag @e[tag=lk.goaltracker] add lk.I0112
scoreboard players set @s lk.goal 730112
...
say completed "Obtain Magenta Candle"
