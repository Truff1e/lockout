execute unless score #I0067 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0067] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0067
tag @e[tag=lk.goaltracker] add lk.I0067
scoreboard players set @s lk.goal 730067
...
say completed "Obtain Goat Horn"
