execute unless score #I0110 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0110] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0110
tag @e[tag=lk.goaltracker] add lk.I0110
scoreboard players set @s lk.goal 730110
...
say completed "Obtain Turtle Scute"
