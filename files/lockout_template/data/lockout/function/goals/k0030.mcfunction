execute unless score #K0030 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.K0030] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.K0030
tag @e[tag=lk.goaltracker] add lk.K0030
scoreboard players set @s lk.goal 750030
