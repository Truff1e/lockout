execute unless score #L0007 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.L0007] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.L0007
tag @e[tag=lk.goaltracker] add lk.L0007
scoreboard players set @s lk.goal 760007
