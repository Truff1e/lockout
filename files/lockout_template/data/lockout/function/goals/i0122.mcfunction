execute unless score #I0122 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0122] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0122
tag @e[tag=lk.goaltracker] add lk.I0122
scoreboard players set @s lk.goal 730122
...
say completed "Obtain Black Candle"
