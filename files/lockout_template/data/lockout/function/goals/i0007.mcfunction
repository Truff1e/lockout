execute unless score #I0007 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0007] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0007
tag @e[tag=lk.goaltracker] add lk.I0007
scoreboard players set @s lk.goal 730007
...
say completed "Obtain Chainmail Armor"
