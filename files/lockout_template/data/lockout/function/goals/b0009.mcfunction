execute unless score #B0009 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.B0009] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.B0009
tag @e[tag=lk.goaltracker] add lk.B0009
scoreboard players set @s lk.goal 660009
