execute unless score #I0075 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0075] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0075
tag @e[tag=lk.goaltracker] add lk.I0075
scoreboard players set @s lk.goal 730075
...
say completed "Obtain Every Type of Seed"
