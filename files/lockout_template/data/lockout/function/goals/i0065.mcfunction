execute unless score #I0065 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0065] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0065
tag @e[tag=lk.goaltracker] add lk.I0065
scoreboard players set @s lk.goal 730065
