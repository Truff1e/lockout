execute unless score #I0088 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0088] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0088
tag @e[tag=lk.goaltracker] add lk.I0088
scoreboard players set @s lk.goal 730088
...
say completed "Brew Jump Boost Potion"
