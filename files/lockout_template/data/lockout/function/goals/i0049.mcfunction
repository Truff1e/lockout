execute unless score #I0049 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0049] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0049
tag @e[tag=lk.goaltracker] add lk.I0049
scoreboard players set @s lk.goal 730049
...
say completed "Obtain Full Diamond Armor"
