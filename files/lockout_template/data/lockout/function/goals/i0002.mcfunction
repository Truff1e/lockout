execute unless score #I0002 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0002] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0002
tag @e[tag=lk.goaltracker] add lk.I0002
scoreboard players set @s lk.goal 730002
