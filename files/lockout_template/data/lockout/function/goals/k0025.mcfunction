execute unless score #K0025 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.K0025] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.K0025
tag @e[tag=lk.goaltracker] add lk.K0025
scoreboard players set @s lk.goal 750025
