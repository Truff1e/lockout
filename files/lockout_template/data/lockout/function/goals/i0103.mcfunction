execute unless score #I0103 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0103] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0103
tag @e[tag=lk.goaltracker] add lk.I0103
scoreboard players set @s lk.goal 730103
...
say completed "Obtain Black Glazed Terracotta"
