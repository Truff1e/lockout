execute unless score #I0068 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0068] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0068
tag @e[tag=lk.goaltracker] add lk.I0068
scoreboard players set @s lk.goal 730068
...
say completed "Obtain Mud Brick Wall"
