execute unless score #I0003 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0003] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0003
tag @e[tag=lk.goaltracker] add lk.I0003
scoreboard players set @s lk.goal 730003
...
say completed "Obtain All Pickaxes"
