execute unless score #I0029 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0029] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0029
tag @e[tag=lk.goaltracker] add lk.I0029
scoreboard players set @s lk.goal 730029
...
say completed "Obtain Scaffolding"
