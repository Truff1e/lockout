execute unless score #K0034 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.K0034] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.K0034
tag @e[tag=lk.goaltracker] add lk.K0034
scoreboard players set @s lk.goal 750034
