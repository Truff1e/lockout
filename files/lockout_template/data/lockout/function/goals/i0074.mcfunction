execute unless score #I0074 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0074] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0074
tag @e[tag=lk.goaltracker] add lk.I0074
scoreboard players set @s lk.goal 730074
...
say completed "Obtain Every Horse Armor"
