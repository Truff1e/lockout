execute unless score #I0096 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0096] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0096
tag @e[tag=lk.goaltracker] add lk.I0096
scoreboard players set @s lk.goal 730096
...
say completed "Obtain Yellow Glazed Terracotta"
