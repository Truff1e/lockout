execute unless score #N0001 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.N0001] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.N0001
tag @e[tag=lk.goaltracker] add lk.N0001
scoreboard players set @s lk.goal 780001
