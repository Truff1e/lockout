execute unless score #I0101 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0101] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0101
tag @e[tag=lk.goaltracker] add lk.I0101
scoreboard players set @s lk.goal 730101
...
say completed "Obtain Blue Glazed Terracotta"
