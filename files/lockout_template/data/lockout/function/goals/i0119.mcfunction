execute unless score #I0119 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0119] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0119
tag @e[tag=lk.goaltracker] add lk.I0119
scoreboard players set @s lk.goal 730119
...
say completed "Obtain Light Blue Candle"
