execute unless score #N0010 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.N0010] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.N0010
tag @e[tag=lk.goaltracker] add lk.N0010
scoreboard players set @s lk.goal 780010
...
say failed "Opponent Takes 100 Damage"
