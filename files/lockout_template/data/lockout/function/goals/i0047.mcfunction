execute unless score #I0047 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0047] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0047
tag @e[tag=lk.goaltracker] add lk.I0047
scoreboard players set @s lk.goal 730047
...
say completed "Obtain All Shovels"
