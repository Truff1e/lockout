...
execute if score #end_on_win lk.util matches 1 as @e[type=armor_stand,tag=lk.team1pts] if score @s lk.points >= #boardSize lk.util run function lockout:game/end/win
execute if score #end_on_win lk.util matches 1 as @e[type=armor_stand,tag=lk.team2pts] if score @s lk.points >= #boardSize lk.util run function lockout:game/end/win
