execute unless score #I0016 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0016] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0016
tag @e[tag=lk.goaltracker] add lk.I0016
scoreboard players set @s lk.goal 730016
...
say completed "Obtain Froglight"
