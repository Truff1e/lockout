execute unless score #I0035 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0035] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0035
tag @e[tag=lk.goaltracker] add lk.I0035
scoreboard players set @s lk.goal 730035
...
say completed "Obtain All Colors of Wool"
