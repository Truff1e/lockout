execute unless score #I0117 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0117] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0117
tag @e[tag=lk.goaltracker] add lk.I0117
scoreboard players set @s lk.goal 730117
...
say completed "Obtain Green Candle"
