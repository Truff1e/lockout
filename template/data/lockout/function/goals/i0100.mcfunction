execute unless score #I0100 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0100] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0100
tag @e[tag=lk.goaltracker] add lk.I0100
scoreboard players set @s lk.goal 730100
...
say completed "Obtain Light Blue Glazed Terracotta"
