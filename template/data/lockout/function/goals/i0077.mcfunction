execute unless score #I0077 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0077] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0077
tag @e[tag=lk.goaltracker] add lk.I0077
scoreboard players set @s lk.goal 730077
...
say completed "Obtain 64 Red Concrete"
