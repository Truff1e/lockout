execute unless score #T0007 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.T0007] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.T0007
tag @e[tag=lk.goaltracker] add lk.T0007
scoreboard players set @s lk.goal 840007
