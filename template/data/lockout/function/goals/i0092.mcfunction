execute unless score #I0092 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0092] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0092
tag @e[tag=lk.goaltracker] add lk.I0092
scoreboard players set @s lk.goal 730092
...
say completed "Obtain Pink Glazed Terracotta"
