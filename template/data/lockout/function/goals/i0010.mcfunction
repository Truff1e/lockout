execute unless score #I0010 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0010] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0010
tag @e[tag=lk.goaltracker] add lk.I0010
scoreboard players set @s lk.goal 730010
...
say completed "Craft a Pot with 4 Sherds"
