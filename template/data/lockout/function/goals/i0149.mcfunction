execute unless score #I0149 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0149] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0149
tag @e[tag=lk.goaltracker] add lk.I0149
scoreboard players set @s lk.goal 730149
...
say completed "Obtain 6 Log Variants"
