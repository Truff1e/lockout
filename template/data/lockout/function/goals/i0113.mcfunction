execute unless score #I0113 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0113] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0113
tag @e[tag=lk.goaltracker] add lk.I0113
scoreboard players set @s lk.goal 730113
...
say completed "Obtain Red Candle"
