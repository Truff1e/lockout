execute unless score #I0057 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0057] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0057
tag @e[tag=lk.goaltracker] add lk.I0057
scoreboard players set @s lk.goal 730057
...
say completed "Get All Overworld Ore Blocks"
