execute unless score #E0007 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.E0007] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.E0007
tag @e[tag=lk.goaltracker] add lk.E0007
scoreboard players set @s lk.goal 690007
