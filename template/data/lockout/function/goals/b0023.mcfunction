execute unless score #B0023 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.B0023] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.B0023
tag @e[tag=lk.goaltracker] add lk.B0023
scoreboard players set @s lk.goal 660023
...
say completed "Breed 12 Unique Mobs"
