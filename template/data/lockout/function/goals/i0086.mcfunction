execute unless score #I0086 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0086] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0086
tag @e[tag=lk.goaltracker] add lk.I0086
scoreboard players set @s lk.goal 730086
...
say completed "Obtain 64 Black Concrete"
