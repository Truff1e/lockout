...
execute if entity @s[team=1] as @a[tag=lk.N0014,team=1] run scoreboard players remove @e[tag=lk.team1pts] lk.points 1
execute if entity @s[team=2] as @a[tag=lk.N0014,team=2] run scoreboard players remove @e[tag=lk.team2pts] lk.points 1
execute as @a[tag=lk.N0014] run scoreboard players remove @s lk.points 1
