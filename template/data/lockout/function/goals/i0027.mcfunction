execute unless score #I0027 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0027] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0027
tag @e[tag=lk.goaltracker] add lk.I0027
scoreboard players set @s lk.goal 730027
...
say completed "Obtain All Raw Ore Blocks"
