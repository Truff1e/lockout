execute unless score #I0038 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0038] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0038
tag @e[tag=lk.goaltracker] add lk.I0038
scoreboard players set @s lk.goal 730038
...
say completed "Obtain Nautilus Shell"
