execute unless score #X0003 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.X0003] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.X0003
tag @e[tag=lk.goaltracker] add lk.X0003
scoreboard players set @s lk.goal 880003
