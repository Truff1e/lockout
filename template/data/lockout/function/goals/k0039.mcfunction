execute unless score #K0039 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.K0039] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.K0039
tag @e[tag=lk.goaltracker] add lk.K0039
scoreboard players set @s lk.goal 750039
