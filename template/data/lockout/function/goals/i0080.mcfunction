execute unless score #I0080 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0080] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0080
tag @e[tag=lk.goaltracker] add lk.I0080
scoreboard players set @s lk.goal 730080
...
say completed "Obtain 64 Lime Concrete"
