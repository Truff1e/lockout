execute unless score #X0010 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.X0010] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.X0010
tag @e[tag=lk.goaltracker] add lk.X0010
scoreboard players set @s lk.goal 880010
