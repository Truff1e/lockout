execute unless score #I0036 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0036] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0036
tag @e[tag=lk.goaltracker] add lk.I0036
scoreboard players set @s lk.goal 730036
...
say completed "Obtain All Log Types"
