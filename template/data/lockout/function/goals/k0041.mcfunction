execute unless score #K0041 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.K0041] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.K0041
tag @e[tag=lk.goaltracker] add lk.K0041
scoreboard players set @s lk.goal 750041
...
say completed "Kill Piglin Brute"
