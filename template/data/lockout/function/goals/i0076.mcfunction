execute unless score #I0076 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0076] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0076
tag @e[tag=lk.goaltracker] add lk.I0076
scoreboard players set @s lk.goal 730076
...
say completed "Obtain 64 Magenta Concrete"
