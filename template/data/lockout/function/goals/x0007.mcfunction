execute unless score #X0007 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.X0007] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.X0007
tag @e[tag=lk.goaltracker] add lk.X0007
scoreboard players set @s lk.goal 880007
