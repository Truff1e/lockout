execute unless score #D0005 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.D0005] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.D0005
tag @e[tag=lk.goaltracker] add lk.D0005
scoreboard players set @s lk.goal 680005
