execute unless score #N0011 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.N0011] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.N0011
tag @e[tag=lk.goaltracker] add lk.N0011
scoreboard players set @s lk.goal 780011
...
say failed "Opponent Dies 3 Times"
