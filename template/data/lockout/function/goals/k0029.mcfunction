execute unless score #K0029 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.K0029] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.K0029
tag @e[tag=lk.goaltracker] add lk.K0029
scoreboard players set @s lk.goal 750029
...
say completed "Kill Yellow Sheep"
