execute unless score #E0009 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.E0009] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.E0009
tag @e[tag=lk.goaltracker] add lk.E0009
scoreboard players set @s lk.goal 690009
...
say completed "Eat 20 Unique Foods"
