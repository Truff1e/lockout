execute unless score #I0078 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0078] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0078
tag @e[tag=lk.goaltracker] add lk.I0078
scoreboard players set @s lk.goal 730078
...
say completed "Obtain 64 Orange Concrete"
