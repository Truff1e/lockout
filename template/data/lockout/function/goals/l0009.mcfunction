execute unless score #L0009 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.L0009] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.L0009
tag @e[tag=lk.goaltracker] add lk.L0009
scoreboard players set @s lk.goal 760009
