execute unless score #I0058 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0058] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0058
tag @e[tag=lk.goaltracker] add lk.I0058
scoreboard players set @s lk.goal 730058
...
say completed "Obtain Full Iron Tools"
