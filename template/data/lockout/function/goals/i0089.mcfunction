execute unless score #I0089 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0089] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0089
tag @e[tag=lk.goaltracker] add lk.I0089
scoreboard players set @s lk.goal 730089
...
say completed "Obtain Tinted Glass"
