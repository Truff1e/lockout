...
execute as @s[scores={lk.unique_crafts=25}] run function lockout:goals/x0022
execute as @s[scores={lk.unique_crafts=50}] run function lockout:goals/x0023
execute as @s[scores={lk.unique_crafts=75}] run function lockout:goals/x0024
