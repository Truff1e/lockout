execute unless score #I0114 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0114] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0114
tag @e[tag=lk.goaltracker] add lk.I0114
scoreboard players set @s lk.goal 730114
...
say completed "Obtain Orange Candle"
