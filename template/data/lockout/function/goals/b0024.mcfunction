execute unless score #B0024 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.B0024] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.B0024
tag @e[tag=lk.goaltracker] add lk.B0024
scoreboard players set @s lk.goal 660024
...
say completed "Breed 15 Unique Mobs"
