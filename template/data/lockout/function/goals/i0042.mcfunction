execute unless score #I0042 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0042] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0042
tag @e[tag=lk.goaltracker] add lk.I0042
scoreboard players set @s lk.goal 730042
...
say completed "Obtain Trail Ruins Armor Trim"
