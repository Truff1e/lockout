execute unless score #A0021 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.A0021] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.A0021
tag @e[tag=lk.goaltracker] add lk.A0021
scoreboard players set @s lk.goal 650021
...
say completed "Get 15 Unique Advancements"
