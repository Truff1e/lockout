execute unless score #I0041 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0041] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0041
tag @e[tag=lk.goaltracker] add lk.I0041
scoreboard players set @s lk.goal 730041
...
say completed "Obtain All Banner Patterns"
