execute unless score #I0097 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0097] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0097
tag @e[tag=lk.goaltracker] add lk.I0097
scoreboard players set @s lk.goal 730097
...
say completed "Obtain Lime Glazed Terracotta"
