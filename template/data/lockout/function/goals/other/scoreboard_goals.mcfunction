...
#goals
execute as @a[scores={lk.levels=5}] run function lockout:goals/n0006
execute as @a[scores={lk.levels=5}] run function lockout:goals/x0001
...
execute as @a[scores={lk.sprint_1km=100000..110000}] run function lockout:goals/x0008

execute as @a[scores={lk.damage_taken=1000..2000}] run function lockout:goals/n0013
...
execute as @a[scores={lk.pumpkin_head_timer=300..}] run function lockout:goals/x0009
