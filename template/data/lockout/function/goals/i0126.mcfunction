execute unless score #I0126 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0126] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0126
tag @e[tag=lk.goaltracker] add lk.I0126
scoreboard players set @s lk.goal 730126
...
say completed "Obtain All Minecart Types"
