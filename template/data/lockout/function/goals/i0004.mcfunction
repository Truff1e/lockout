execute unless score #I0004 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0004] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0004
tag @e[tag=lk.goaltracker] add lk.I0004
scoreboard players set @s lk.goal 730004
...
say completed "Obtain All Rail Types"
