execute unless score #E0004 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.E0004] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.E0004
tag @e[tag=lk.goaltracker] add lk.E0004
scoreboard players set @s lk.goal 690004
