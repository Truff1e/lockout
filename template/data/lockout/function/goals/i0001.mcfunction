execute unless score #I0001 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0001] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0001
tag @e[tag=lk.goaltracker] add lk.I0001
scoreboard players set @s lk.goal 730001
...
say completed "Obtain 5 Unique Saplings"
