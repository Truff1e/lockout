...
execute if score #show_progress lk.util matches 1 run title @s actionbar [{"text": "You have crafted ", "italic": true, "color": "gray"},{"score":{"name": "@s", "objective": "lk.unique_crafts"}, "italic": true, "color": "gray"},{"text": " unique items", "italic": true, "color": "gray"}]