...
execute if entity @s[team=1] as @a[tag=lk.N0013,team=2] run scoreboard players remove @s lk.points 1
execute if entity @s[team=2] as @a[tag=lk.N0013,team=1] run scoreboard players remove @s lk.points 1
