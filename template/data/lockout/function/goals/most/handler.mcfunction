...
execute if entity @a[tag=lk.N0014] store result score #levels lk.util run scoreboard players get @a[tag=lk.N0014,limit=1] lk.levels

execute unless entity @a[tag=lk.N0015] unless score #unique_crafts lk.util matches ..10 run scoreboard players remove #unique_crafts lk.util 1
execute if entity @a[tag=lk.N0015] store result score #unique_crafts lk.util run scoreboard players get @a[tag=lk.N0015,limit=1] lk.unique_crafts