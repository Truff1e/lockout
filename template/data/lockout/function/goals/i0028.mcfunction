execute unless score #I0028 lk.enabled_goals matches 1 run return fail
execute if score #end_seen lk.util matches 1 run return fail
execute if entity @e[tag=lk.I0028] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0028
tag @e[tag=lk.goaltracker] add lk.I0028
scoreboard players set @s lk.goal 730028
...
say completed "Obtain Red Nether Brick Stairs"
