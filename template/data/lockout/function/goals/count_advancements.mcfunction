...
execute if score #show_progress lk.util matches 1 run title @s actionbar [{"text": "You have gotten ", "italic": true, "color": "gray"},{"score":{"name": "@s", "objective": "lk.unique_advancements"}, "italic": true, "color": "gray"},{"text": " unique advancements", "italic": true, "color": "gray"}]