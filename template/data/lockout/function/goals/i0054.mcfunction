execute unless score #I0054 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0054] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0054
tag @e[tag=lk.goaltracker] add lk.I0054
scoreboard players set @s lk.goal 730054
...
say completed "Obtain Written Book"
