execute unless score #E0002 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.E0002] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.E0002
tag @e[tag=lk.goaltracker] add lk.E0002
scoreboard players set @s lk.goal 690002
...
say completed "Eat Poisonous Potato"
