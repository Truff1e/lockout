execute unless score #I0121 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0121] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0121
tag @e[tag=lk.goaltracker] add lk.I0121
scoreboard players set @s lk.goal 730121
...
say completed "Obtain Purple Candle"
