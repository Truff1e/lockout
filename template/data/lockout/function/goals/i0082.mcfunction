execute unless score #I0082 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0082] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0082
tag @e[tag=lk.goaltracker] add lk.I0082
scoreboard players set @s lk.goal 730082
...
say completed "Obtain 64 Light Blue Concrete"
