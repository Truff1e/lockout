execute unless score #B0005 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.B0005] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.B0005
tag @e[tag=lk.goaltracker] add lk.B0005
scoreboard players set @s lk.goal 660005
