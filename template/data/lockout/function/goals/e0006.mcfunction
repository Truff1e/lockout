execute unless score #E0006 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.E0006] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.E0006
tag @e[tag=lk.goaltracker] add lk.E0006
scoreboard players set @s lk.goal 690006
