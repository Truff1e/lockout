execute unless score #K0032 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.K0032] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.K0032
tag @e[tag=lk.goaltracker] add lk.K0032
scoreboard players set @s lk.goal 750032
