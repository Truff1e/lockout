execute unless score #I0023 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0023] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0023
tag @e[tag=lk.goaltracker] add lk.I0023
scoreboard players set @s lk.goal 730023
...
say completed "Obtain Mossy Stone Brick Wall"
