execute unless score #I0009 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.I0009] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.I0009
tag @e[tag=lk.goaltracker] add lk.I0009
scoreboard players set @s lk.goal 730009
...
say completed "Obtain Comparator"
