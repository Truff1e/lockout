execute unless score #K0043 lk.enabled_goals matches 1 run return fail
execute if entity @e[tag=lk.K0043] run return fail
execute if entity @s[team=spectator] run return fail
tag @s add lk.K0043
tag @e[tag=lk.goaltracker] add lk.K0043
scoreboard players set @s lk.goal 750043
